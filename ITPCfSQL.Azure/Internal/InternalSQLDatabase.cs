...
namespace ITPCfSQL.Azure.Internal
{
    public class InternalSQLDatabase
    {
        ...
        public static Responses.SQLDatabaseListServersResponseWithGeneric GetServicesWithGeneric(
            ...
            Guid subscriptionId)
        {
            ...
            if (response.StatusCode == System.Net.HttpStatusCode.OK)
            {
                System.Xml.Serialization.XmlSerializer ser = new System.Xml.Serialization.XmlSerializer(
                    typeof(Responses.SQLDatabaseListServersResponseWithGeneric));
                return (Responses.SQLDatabaseListServersResponseWithGeneric)ser.Deserialize(response.GetResponseStream());
            }
            else
                throw new Exceptions.UnexpectedResponseTypeCodeException(System.Net.HttpStatusCode.OK, response.StatusCode);
        }

        public static Responses.SQLDatabaseListServersResponseWithoutGeneric GetServicesWithoutGeneric(
            System.Security.Cryptography.X509Certificates.X509Certificate2 certificate,
            Guid subscriptionId)
        {
            Uri uri = new Uri(
            ...
            if (response.StatusCode == System.Net.HttpStatusCode.OK)
            {
                ...
                System.Xml.Serialization.XmlSerializer ser = new System.Xml.Serialization.XmlSerializer(
                    typeof(Responses.SQLDatabaseListServersResponseWithoutGeneric));
                return (Responses.SQLDatabaseListServersResponseWithoutGeneric)ser.Deserialize(response.GetResponseStream());
            }
            else
                throw new Exceptions.UnexpectedResponseTypeCodeException(System.Net.HttpStatusCode.OK, response.StatusCode);
        }
