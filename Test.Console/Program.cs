...
namespace TestConsole
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var s = InternalSQLDatabase.GetServicesWithGeneric(cert, Guid.Parse("002842b4-7fb0-4fd2-b269-1959fa60b89d"));
            var t = InternalSQLDatabase.GetServicesWithoutGeneric(cert, Guid.Parse("002842b4-7fb0-4fd2-b269-1959fa60b89d"));
